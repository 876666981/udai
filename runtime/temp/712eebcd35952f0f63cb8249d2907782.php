<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/home/wwwroot/udai/public/../application/index/view/index/udai_welcome.html";i:1530151716;}*/ ?>
<!DOCTYPE html>
											...
											<td colspan="3">
												<label>
													...
													<div class="card" style="margin-top:30px;float:left;">
														<div class="img" style="width:100px;"><img src="uploads/<?php echo $gds['img']; ?>" alt="" class="cover"></div>
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								...
								<a class="picked-item" href="">
									<img src="uploads/<?php echo $lt['img']; ?>|msubstr=0,45" alt="" class="cover">
									<div class="look_price">¥<?php echo $lt['price']; ?></div>
								</a>
								<?php endforeach; ?>
							</div>
						</div>
