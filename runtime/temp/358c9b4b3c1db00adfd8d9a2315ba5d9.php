<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/home/wwwroot/udai/public/../application/index/view/index/udai_shopcart.html";i:1530151710;}*/ ?>
<!DOCTYPE html>
			...
			<div class="user-content__box clearfix bgf">
				...
				<form action="orderinfo" method="post" class="shopcart-form__box" enctype="multipart/form-data">
					<table class="table table-bordered">
						...
						<tbody>
							<?php foreach($goodcar as $k=>$v): ?>
							<tr class="order_lists">
								<td scope="row">
									<div class="checkbox">
										<input type="hidden" name="id" value="<?php echo $v['id']; ?>" class="id">
										<input type="checkbox" class="price" name="price" style="margin-left:1px;margin-top:40px;" onclick="fun(this)" value="<?php echo $v['id']; ?>">
										<div class="img">
											<img src="uploads/<?php echo $v['carimg']; ?>" alt="" class="cover" style="margin-left:40px;width:60%;">

											<img src="<?php echo $v['carimg']; ?>" alt="" class="cover">

										</div>
									</div>
								</td>
								<td>
									<input type="hidden" name="stock" value="<?php echo $v['stock']; ?>">
									<input type="hidden" name="sid" value="<?php echo $v['sid']; ?>">
									<div class="name ep3"><?php echo $v['goodsname']; ?></div>
									<p class="carval" style="color: #888"><?php echo $v['carval']; ?></p>
								</td>
								<td class="dj">
									<span>￥</span>
								...
								<td>
									<div class="cart-num__box">
										<input type="button" class="sub" value="-" onclick="sup(this,<?php echo $v['id']; ?>)">
										<input type="text" class="val" value="<?php echo $v['carnum']; ?>" maxlength="1" name="val">
										<input type="button" class="add" value="+" onclick="add(this,<?php echo $v['id']; ?>)">
									</div>
								</td>
								<td class="xj">
									<span>￥</span>
									<span name="xj"><?php echo $v['price']*$v['carnum']; ?></span>
								</td>
								<td><a href="javascript:;" onclick="delcar(this,<?php echo $v['id']; ?>)">删除</a></td>
							</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
						...
						// })
							function delcars(){
								if ($('.price').is(':checked')) {
				                    ...
				                    window.location.href = "/index/index/carsdel/id/"+chk_value;
					                      return false;
									}else{
										return false;
									}
