<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/home/wwwroot/udai/public/../application/index/view/personal/udai_order.html";i:1530159388;}*/ ?>
<!DOCTYPE html>
...
<head>
	...
	<link rel="stylesheet" href="/static/index/css/2.css">
...
<body>
						...
						<div class="order-panel">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="all">
									<table class="table text-center">
										...
										<tr class="order-item">
											<td colspan="3">
												<label>
													<a href="" class="num" style="margin-left:-160px;">
														<?php echo date("Y-m-d H:i:s",$or['createtime']); ?>&nbsp;&nbsp;&nbsp;&nbsp;订单号: <?php echo $or['orderhao']; ?>
													</a>
													<?php foreach($as as $key=>$gds): if($gds['orderid']==$or['id']): ?><a href="itemshow?id=<?php echo $gds['goodsid']; ?>">
													<div class="card" style="margin-top:30px;float:left;">
														
															<div class="img" style="width:100px;">
																<img src="uploads/<?php echo $gds['img']; ?>" alt="" class="cover">
															</div>
															<div class="name ep2" style="width:100px;"><?php echo $gds['goods_name']; ?></div>
														<div class="format" style="width:100px;margin-left:22px;">颜色 尺码:<?php echo $gds['attr']; ?></div>
														
													</div></a>
													<div class="card" style="margin-top:10px;float:left;margin-left:300px;">
														<span style="margin-top:-60px;float:left;margin-left:160px;">￥<?php echo $gds['price']; ?></span>
														<span style="margin-left:290px;margin-top:-60px;float:left;"><?php echo $gds['num']; ?></span>
													</div>
								...
								<div role="tabpanel" class="tab-pane fade" id="pay">
									<table class="table text-center">
										<tr>
											...
											<?php foreach($order as $k=>$or): if($or['state']==0): ?>
											<tr class="order-item">
											<td colspan="3">
												<label>
													<a href="" class="num" style="margin-left:-160px;">
								...
								<div role="tabpanel" class="tab-pane fade" id="emit">
									...
									<?php foreach($order as $k=>$or): if($or['state']==1): ?>
										<tr class="order-item">
											<td colspan="3">
												<label>
													...
													<div class="card" style="margin-top:30px;float:left;">
														<div class="img"><img src="uploads/<?php echo $gds['img']; ?>" alt="" class="cover"></div>
															<div class="name ep2" style="width:100px;"><?php echo $gds['goods_name']; ?></div>
														<div class="format" style="width:100px;margin-left:22px;">颜色 尺码:<?php echo $gds['attr']; ?></div>
													</div>
													<div class="card" style="margin-top:10px;float:left;margin-left:220px;">
								...
								<div role="tabpanel" class="tab-pane fade" id="take">
									<table class="table text-center">
										<tr>
											...
											<?php foreach($order as $k=>$or): if($or['state']==2): ?>
												<tr class="order-item">
											<td colspan="3">
												<label>
													<a href="" class="num" style="margin-left:-160px;">
								...
								<div role="tabpanel" class="tab-pane fade" id="eval">
									<table class="table text-center">
										...
										<?php foreach($order as $k=>$or): if($or['state']==3): ?>
										<tr class="order-item">
											<td colspan="3">
												<label>
													<a href="" class="num" style="margin-left:-160px;margin-bottom:40px;">
	...
	<script>
		...
		function shouhuo(ob,id){
			$.get('ordershouhuo',{id:id},function(data){
				if (data>0) {
					alert('确认收货成功！');
					location.reload();
				}
		...
		function deletes(ob,id){
			$.get('orderdelete',{id:id},function(data){
				if (data>0) {
					alert('删除订单成功！');
					location.reload();
				}
